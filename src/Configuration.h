...
#define DELTA_SMOOTH_ROD_OFFSET 196.5 // mm
...
#define MANUAL_Z_HOME_POS 180.0 // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200, 200, 200, 99.016}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 200}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {4000, 4000, 4000, 8000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          700    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  6000   // X, Y, Z and E max acceleration in mm/s^2 for retracts
